                                ...
                                <Col md="6">
                                    <div className="form-group">
                                        ...
                                        <div className="form-control-wrap">
                                            ...
                                            {assignRoleErrors.roleName && <span className="invalid">{assignRoleErrors.roleName?.message}</span>}
                                        </div>
                                    </div>
                                </Col>
                                <Col md="6">
                                    <div className="form-group">
                                        ...
                                        <div className="form-control-wrap">
                                            ...
                                            {assignRoleErrors.roleSlug && <span className="invalid">{assignRoleErrors.roleSlug?.message}</span>}
                                        </div>
                                    </div>
                                </Col>
                            </Row>
                                        ...
                                        <div className="form-control-wrap">
                                            {allPermissions && allPermissions.length > 0 && (
                                                <Controller
                                                    ...
                                                    control={control}
                                                    render={({ field }) => (
                                                        <Select isMulti options={allPermissions} isSearchable={true} isClearable={true} {...field} />
                                                    )}
                                                />
                                            )}
                    ...
                    <DataTableBody>
                        <DataTableHead  >
                            <DataTableRow size="md" >
                                <span className="sub-text" style={{ height: "60px", width: "100%", display: "flex", alignItems: "center", cursor: "pointer" }}>

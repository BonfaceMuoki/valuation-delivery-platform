...
const PermissionList = () => {
    ...
    const { register: registerPermission, control, setValue: setPermissionValue, reset: resetpermissionForm, getValues: getPermissionValues, handleSubmit: handleSubmitPermissionForm, formState: { errors: createPermissionErrors } } = useForm({
                ...
                <ModalBody>
                    <form onSubmit={handleSubmitPermissionForm(onSubmitAssignPermissionForm)}>
                            ...
                            <Col md="6">
                                <div className="form-group">
                                    ...
                                    <div className="form-control-wrap">
                                        ...
                                        {createPermissionErrors.permissionName && <span className="invalid">{createPermissionErrors.permissionName?.message}</span>}
                                    </div>
                                </div>
                            </Col>
                            <Col md="6">
                                <div className="form-group">
                                    ...
                                    <div className="form-control-wrap">
                                        ...
                                        {createPermissionErrors.permissionSlug && <span className="invalid">{createPermissionErrors.permissionSlug?.message}</span>}
                                    </div>
                                </div>
                            </Col>
                        </Row>
                        <Row style={{ marginTop: "10px" }}>
                            <Col md="12">
                                <Button color="primary" type="submit" style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                    Submit
                                </Button>
                            </Col>
                        </Row>

...
import { useGetPermissionsListQuery, useCreatePermissionMutation, useUpdatePermissionMutation, useDeletePermissionMutation, useGetRolesListQuery } from "../../api/admin/adminActionsApi";
            ...
            >
                <DataTableBody>
                    <DataTableHead  >
                        ...
                        <DataTableRow size="md">
                            <span className="sub-text" style={{ height: "60px", width: "100%", display: "flex", alignItems: "center" }}>  <strong>Phone  </strong></span>
                        </DataTableRow>
                        <DataTableRow size="md">

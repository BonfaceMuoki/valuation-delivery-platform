  ...
  const submitLoginForm = async (data) => {
    ...
    if ("error" in userData) {
      ...
      if (userData.data.user.role_name === "Super Admin") {
        ...
        (userData.data.user.role_name === "Report Uploader") |
        (userData.data.user.role_name === "Report Uploader Admin")
      ) {
        navigateto("/valuer-dashboard");
      } else if (
        userData.data.user.role_name === "Report Accesor" ||
        userData.data.user.role_name === "Report Accessor Admin"
      ) {
        navigateto("/accessor-dashboard");
      }
    }
  };
